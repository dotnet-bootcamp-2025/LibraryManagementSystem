...
public class AppDbContext : DbContext
{
    ...
    public DbSet<Domain.Entities.LibraryItem> LibraryItems { get; set; }
    public DbSet<Domain.Entities.BorrowedItem> BorrowedItems { get; set; }
    ...
    {
        base.OnModelCreating(modelBuilder); //primero mandamos llamar la implementacion de la clase base
